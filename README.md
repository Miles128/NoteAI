...
**AI-native personal knowledge base desktop app** — collect sources, compile knowledge, discover links, and chat with the **RAG Assistant** grounded in your workspace.
...
4. 💬 **Open RAG Assistant** — ask questions or browse notes & graph
...
- 🧠 **User profile** — Settings → RAG Assistant, Markdown background & preferences

**Retrieval**: query → HyDE → zvec + bm25s hybrid (dense 0.7 + BM25 0.3) → rerank → MMR → streaming LLM
...
**AI 原生的个人知识库桌面应用** — 采集资料、编译知识、发现关联，用「RAG 助手」从你的笔记里回答问题。
