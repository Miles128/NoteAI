# NoteAI PRD — AI 原生个人知识库（历史归档，已失效）

> **不要将本文作为产品或实现依据。** 当前唯一有效 PRD 是 [`documents/PRD.md`](../../documents/PRD.md)。
>
> 本文保留于 2026-07 的历史状态，其中包含已经废弃的方向（例如自动写入 L1 个人记忆、内建 Agent 文件操作）；这些内容与当前产品边界不一致。

**版本**：v2.2  
**日期**：2026-06-21  
**状态说明**：本文件是 2026-06-21 的设计快照，不反映当前代码库或路线图；请勿据此判断功能状态。
