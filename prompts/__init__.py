...
SEMANTIC_CLAIM_EXTRACT_PROMPT = get_prompt("semantic_extract", "CLAIM_EXTRACTION_PROMPT")
SEMANTIC_BATCH_CLAIM_EXTRACT_PROMPT = get_prompt("semantic_extract", "BATCH_CLAIM_EXTRACTION_PROMPT")
