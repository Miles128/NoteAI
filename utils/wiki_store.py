"""WIKI.md 底层存储层 — 路径解析、标题解析、编号、综述开关、CRUD、去重、文件夹同步。

本模块是 WIKI.md 唯一的底层实现；生产写入统一走 sidecar/wiki_utils.py 门面。
（合并自原 utils/wiki_manager.py、utils/topic_dedup.py、utils/wiki_crud.py、utils/wiki_sync.py。）
"""
