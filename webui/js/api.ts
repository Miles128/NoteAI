...
var API_DEFS: ApiDef[] = [
    ...
    { name: 'resolveCrossKindMerges', method: 'resolve_cross_kind_merges', params: function(dryRun) { return { dry_run: dryRun === true }; }, write: true },
    ...
    { name: 'verifySemanticClaim', method: 'verify_semantic_claim', params: function(id, agent, method) { return { id: id, agent: agent, method: method || 'cli' }; }, write: true },
    ...
    { name: 'runCliAgent', method: 'run_cli_agent', params: function(agentId, prompt, workspacePath, options) { var opts = options || {}; return { agent_id: agentId, prompt: prompt, workspace_path: workspacePath || '', new_session: !!opts.newSession, model: opts.model || '' }; }, write: true },
