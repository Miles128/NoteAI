...
function listMeta(item) {
    ...
    if (_category === 'claims') return '<span>' + esc(t('semantic.evidenceCount', { count: item.evidence_count || 0 })) + '</span><span>' + Math.round((item.confidence || 0) * 100) + '%</span>';
