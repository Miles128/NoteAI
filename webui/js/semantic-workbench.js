...
function configureStatusFilter() {
    ...
    if (!status) return;
    status.hidden = _category !== 'claims' && _category !== 'conflicts' && _category !== 'links';
    if (_category === 'claims') {
